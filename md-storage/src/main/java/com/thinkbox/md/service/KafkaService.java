...
public class KafkaService {
	...
	private String topicDBgetDailysummarySingle;

	@Value("${kafka.topic.dbupdate-historical-all}")
	private String topicDBgetHistoricalAll;
...
//				}
	...
	private void getHistoricalTotalFromInstruments(Map<String, Object> map) {
...
//				}
	...
	@Async(ASYNC_EXECUTOR)
	@KafkaListener(topics = "${kafka.topic.dbget-dailysummary-single}", containerFactory = CONTAINER_FACTORY_MAP)
	private void getDailySummarySingle(Map<String, Object> map) {
		log.info(STRING_LOGGER_RECEIVED_MESSAGE, topicDBgetDailysummarySingle, map.toString());
...
//	}
	...
	@Async(ASYNC_EXECUTOR)
	@KafkaListener(topics = "${kafka.topic.dbupdate-historical-all}", containerFactory = CONTAINER_FACTORY_MAP)
	public void updateHistoricalAll(Map<String, Object> map) {
		log.info(STRING_LOGGER_RECEIVED_MESSAGE, topicDBgetHistoricalAll, map.toString());
